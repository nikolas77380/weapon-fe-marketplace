    ...
    <Link href="/">
      <div className={cn("flex items-center gap-1.5 sm:gap-2", className)}>
        <div className="relative">
          <div
            className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-gradient-to-br from-gold-main to-gray-secondary rounded-lg 
            flex items-center justify-center border border-gold-main/50 
          ...
          >
            <div className="relative flex items-center justify-center">
              <Shield className="size-6 sm:size-7 lg:size-8 text-white" />
              <span className="absolute font-bold text-white z-10 text-xs sm:text-sm lg:text-base">
                E
              </span>
            </div>
          </div>
